...
class UploadAssetScreen extends StatefulWidget {
  const UploadAssetScreen({super.key});

  @override
  State<UploadAssetScreen> createState() => _UploadAssetScreenState();
}
    ...
    try {
      ...
      for (var image in _images) {
        final storageRef = FirebaseStorage.instance.ref().child(
          'assets/${DateTime.now().toIso8601String()}_${image.name}',
        );
        String downloadUrl;
        if (kIsWeb) {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Failed to upload asset: $e')));
    } finally {
      setState(() {
        _isLoading = false;
      });
            ...
            children: [
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: _isLoading ? null : _uploadAsset,
